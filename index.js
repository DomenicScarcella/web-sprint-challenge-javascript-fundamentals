...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    return zooAnimals.map(function(thing){
      return thing.animal_name.toLowerCase();
    });
  }
  ...
  */
  ...
  function lowPopulationAnimals(){
    return zooAnimals.filter(function(thing){
  ...
  */
  ...
  function USApop(){
    return zooAnimals.reduce(function(accumulator, thing){
      return accumulator + thing.population;
    },0)
  }
